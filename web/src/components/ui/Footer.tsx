...
export function Footer() {
  return (
    <footer className="relative bg-[#000000] text-[#A1A1A1] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <motion.a
                ...
                className="w-9 h-9 rounded-lg bg-[#0A0A0A] border border-[#262626] hover:border-[#10B981] hover:bg-[#141414] flex items-center justify-center text-[#A1A1A1] hover:text-[#10B981] transition-all duration-200"
              >
          ...
          {/* For Customers */}
          <div>
            <h3 className="text-[#FAFAFA] font-semibold mb-4">For Customers</h3>
            <ul className="space-y-3 text-sm">
              {footerLinks.customers.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="hover:text-[#10B981] transition-colors inline-flex items-center gap-1 group"
                  >
                    {link.label}
          ...
          {/* For Businesses */}
          <div>
            <h3 className="text-[#FAFAFA] font-semibold mb-4">For Businesses</h3>
            <ul className="space-y-3 text-sm">
          ...
          {/* Support */}
          <div>
            <h3 className="text-[#FAFAFA] font-semibold mb-4">Support</h3>
            <ul className="space-y-3 text-sm">
              {footerLinks.support.map((link) => (
                <li key={link.label}>
                  {link.disabled ? (
                    <span className="text-[#525252] cursor-not-allowed flex items-center gap-1">
                      {link.label}
                      <span className="text-xs bg-[#141414] border border-[#262626] px-1.5 py-0.5 rounded text-[#525252]">Soon</span>
                    </span>
                  ) : (
                    <Link
                      href={link.href}
        ...
        <div className="border-t border-[#262626] mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-[#525252] flex items-center gap-2">
              <span className="inline-flex w-2 h-2 bg-[#10B981] rounded-full animate-pulse" />
