          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {footerLinks.support.map((link) => (
                <li key={link.label}>
                  {link.disabled ? (
                    <span className="text-gray-600 cursor-not-allowed flex items-center gap-1">
                      {link.label}
                      <span className="text-xs bg-gray-800 px-1.5 py-0.5 rounded">Soon</span>
                    </span>
                  ) : (
                    <Link
                      href={link.href}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-gray-500 flex items-center gap-2">
              <span className="inline-flex w-2 h-2 bg-purple-500 rounded-full animate-pulse" />
